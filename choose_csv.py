...
#key is reaction name and value is MT name for pyNE 
name_dict = {"n,2n":"2n","n,3n":"z_3n","n,4n":"z_4n" \
                ,"fission":"fission", "elastic":"elastic", \
                    "inelastic":"inelastic","total":"total"}
...
# use the mt_number variables to do further processing
